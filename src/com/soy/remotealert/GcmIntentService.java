...
public class GcmIntentService extends IntentService {
    ...
    private void sendNotification2(String msg) {
        ...
        .bigText("Remote Alert notifications"))
        .setContentText(msg);
    ...
    private void sendNotification(String msg ){
    	...
    	notiStyle.setBigContentTitle("Message Received");
    	...
    	builder.setContentIntent(contentIntent)
    	            ...
    	            .setTicker("Better answer")
    	            .setWhen(System.currentTimeMillis())
    	            .setContentTitle("Pitch to Expand message")
    	            .setAutoCancel(true)
    	            .setStyle(notiStyle)    	            
    	            .setContentText(msg);
